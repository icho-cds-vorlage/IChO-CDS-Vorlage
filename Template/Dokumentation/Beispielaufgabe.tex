...
\begin{scheme}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{Abbildungen/Dokumentation/Komplex.eps}
...
\ocanfang
\oc{\textbf{1}}{\includegraphics[scale=\ocscale]{Abbildungen/Dokumentation/beta_lacton.eps}}{}
\oc{\textbf{2}}{\includegraphics[scale=\ocscale]{Abbildungen/Dokumentation/H2CO3.eps}}{}
\oc{\textbf{3}}{\includegraphics[width=0.5\linewidth]{Abbildungen/Dokumentation/H2CO3.eps}}{}
\ockasten{112}{4}
\ocende
% \kastenarray
...
\begin{scheme}[H]
    \includegraphics[width=\linewidth]{Abbildungen/Dokumentation/mandala.jpg}
\end{scheme}
\punkteausgabe
