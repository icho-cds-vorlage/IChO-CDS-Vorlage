...
\begin{itemize}
    ...
    \item Typische OC-K\"asten k\"onnen erhalten werden mit: \hypertarget{oc}{} \hypertarget{ocanfang}{} \hypertarget{ochilf}{} \hypertarget{ockasten}{} \todo{Description of \textbackslash ochilf ? At least if still in use; Documentation for xinchengs variant of oc kasten; Decision on how to use which (Config variable to choose or different commands)}\\
