...
%         % Page size
%         \draw[use as bounding box, opacity=0] (0,0) rectangle (\paperwidth, \paperheight);
        
%         % Define positions for the markers
%         % Corners
%         \node[anchor=north west] at (current page.north west) {\includegraphics[width=1cm]{4x4_1000-0.png}};
%         \node[anchor=north east] at (current page.north east) {\includegraphics[width=1cm]{4x4_1000-0.png}};
%         \node[anchor=south west] at (current page.south west) {\includegraphics[width=1cm]{4x4_1000-0.png}};
%         \node[anchor=south east] at (current page.south east) {\includegraphics[width=1cm]{4x4_1000-0.png}};
%     \end{tikzpicture}
% }
...
\textit{Für kursive Hervorhebung kann dies genuztzt werden}. \textbf{Für fette Hervorherbung dies}.
