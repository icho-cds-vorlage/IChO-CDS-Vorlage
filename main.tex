...
\def\wettbewerb{vlw} %cds oder icho oder vlw
\def\klasse{12}
\def\bundesland{Bayern}
\def\cyear{2026}
\def\round{3} % 1, 2, 3, 4
\def\exam{1} % 1, 2; Nur fuer 3. & 4. Runde
\def\fullname{Vierländerwettbewerb \cyear} %z.B. 56. IChO 2024 in Saudi-Arabien (fuer Deckblatt)
...
\def\suscode{KEIN SCHÜLERCODE!}\opt{icho}{\opt{rd2}{\def\susbl{}}}
...
\opt{vlw}{\subfile{./Hilfsdateien/deckblatt_vlw.tex}}
\opt{icho, cds}{\subfile{./Hilfsdateien/deckblatt}}
