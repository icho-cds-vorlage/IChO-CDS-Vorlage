...
%Kommentare im Dokument sind mit \textit{\hypertarget{authorcom}{\textbackslash authorcom\{\}}}, \textit{\hypertarget{corone}{\textbackslash corone\{\}}}, \textit{\hypertarget{cortwo}{\textbackslash cortwo\{\}}} und \textit{\hypertarget{corend}{\textbackslash corend\{\}}} m\"oglich. Um alle Kommentare auszublenden, kann \textit{\textbackslash usepackage\{todonotes\}} ge\"andert werden zu \textit{\textbackslash usepackage[disable]\{todonotes\}}. 
...
Die Aufgabe sollte zuerst selbst gelöst werden, ohne die Lösung anzuschauen. Dadurch fällt besonders gut auf, wenn es schwer ist auf eine Lösung zu kommen oder die Aufgabenstellung unklar formuliert ist bzw. nicht zum Erwartungshorizont passt. \\ Die nachfolgende Auflistung soll als Checkliste der wichtigsten Dinge verstanden werden. 
\begin{itemize}
    ...
    \item Ist die Aufgabe richtig? Bespielsweise sind Basen angegeben, die bei organischen Reaktionen zum Abfangen von Säure gebraucht werden, auch wenn sie an der eigentlichen Reaktion nicht beteiligt sind? 
    \item Sind Schemata, Formelzeichen, ... konsistent in der Aufgabe?
    \item Sind alle Abkürzungen erklärt?
    \item Sind alle Lösungen wirklich eindeutig und fachlich korrekt? Dies umfasst gegebenenfalls das Recherchieren in wissenscahftlichen Publikationen (basiert eine Aufgabe auf einer oder mehreren Publikationen, soll dies daher im Quelltext angegeben werden) Es ist sehr wichtig, sich bei der fachlichen Korrektheit von Aufgabe und Lösungen ohne den kleinsten Zweifel sicher zu sein. Wenn andere Lösungen denkbar sind und mit dem vernünftigerweise zu erwartenden Wissen der Teilnehmer nicht ausgeschlossen werden können, besteht die Kunst darin, einen Tipp zu geben, der die Lösung nicht verrät / die zu prüfende Kompetenz nicht ersetzt, aber zur Eindeutigkeit führt.
    \item Ist die Schwierigkeit der Aufgabe angemessen? Bei der 4. Runde bedeutet dies auch einen Vergleich mit den Preps, d.h. besteht tehmatisch und vom Schwierigkeitsgrad her eine Parallele zu den Preps?
