...
\begin{document}
\renewcommand{\tasktitle}{Titel\texorpdfstring{$^1$}{}} % texorpdfstring wird in Titeln und Captions verwendet, wenn Zeichen verwendet werden, die so im Inhaltsverzeichnis nicht darstellbar sind; normalerweise weisen Aufgabentitel keine Fussnote auf
...
\begin{scheme}[H]
    \centering
    \includegraphics[scale=\ocscale]{Dokumentation/Komplex.eps}
...
\begin{scheme}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{Dokumentation/Komplex.eps}
    \caption{Zweite Synthese f\"ur die Tonne}
\end{scheme}

Zu der Darstellung der OC- L\"osungsk\"astchen dient die Befehlfamilie \textbackslash oc{}{}{}\\
In der folgenden Teilaufgabe folgt das Einf\"ugen von OC Formeln Bildern und OC K\"astchen. 

\ocanfang
\oc{\textbf{1}}{\includegraphics[scale=\ocscale]{Dokumentation/beta_lacton.eps}}{}
\oc{\textbf{2}}{\includegraphics[scale=\ocscale]{Dokumentation/H2CO3.eps}}{}
\oc{\textbf{3}}{\includegraphics[width=0.5\linewidth]{Dokumentation/H2CO3.eps}}{}
\ockasten{112}{4}
\ocende
% \kastenarray
...
\begin{scheme}[H]
    \includegraphics[width=\linewidth]{Dokumentation/mandala.jpg}
\end{scheme}
\punkteausgabe
...
\selfkasten{7cm}{
    \vspace{5pt}
    \setstretch{1.3}
    In diesem L\"uckentext werden L\"ucken mittels \opt{0}{\_\_\_\_\_\_\_\_\_\_\_   }\sol{\underline{\textbackslash opt\{0\} und \textbackslash sol}}\opt{2}{\punkte{2}} dargestellt. Um die L\"ucken des Textes zu sehen, kannst du im main.tex \textbackslash solution auf \opt{0}{\_\_}\sol{\underline{0}}\opt{2}{\punkte{1}} setzen.
    
    Hier wird noch die Punktzahl der Teilaufgabe halbiert. \punktehalbieren Zum Debuggen k\"onnen wir uns den Z\"ahler ansehen, der immer das 20-fache der Punktzahl speichert und hier nach der Halbierung korrekterweise \themulteilaufpunkt{} enth\"alt.
    
    Dies ist in diesem Fall unsinnig, soll aber diese M\"oglichkeit aufzeigen. In seltenen F\"allen (wenn eine Umgebung genutzt wird, die den Code zur korrekten Darstellung mehrfach ausf\"uhren muss), werden Punkte mehrfach gez\"ahlt, dann hilft dieser Befehl. Als Alternative werden die Punkte manuell auf den korrekten Wert gesetzt (richtig rechnen!), wobei das 20-fache der Punktzahl eingetragen wird: \setcounter{multeilaufpunkt}{60}
}

Formeln im Text k\"onnen mit align und labeln erstellt werden, um verlinkt zu werden z.B. Gleichung \ref{G:test-Gl}:
\begin{align}
...
\begin{table}[H]
    ...
    \hline
        ...
        $\Delta_\mathrm{f}H^{\circ}_\mathrm{m}$ / $\si{\kilo\joule\per\mole}$ & -74,85 & -241,8 & -110,5 & 0\\\hline
        $S^{\circ}_\mathrm{m}$ / $\si{\joule\per\mole\per\kelvin}$ & 186,2 & 188,9 & 198,0 & 130,6\\\hline
        $C_{p, \mathrm{m}}$ / $\si{\joule\per\mole\per\kelvin}$ & 35,31 & 33,58 & 29,14 & 28,82\\\hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \toprule
        ...
        $\Delta_\mathrm{f}H^{\circ}_\mathrm{m}$ / $\si{\kilo\joule\per\mole}$ & -74,85 & -241,8 & -110,5 & 0\\
        $S^{\circ}_\mathrm{m}$ / $\si{\joule\per\mole\per\kelvin}$ & 186,2 & 188,9 & 198,0 & 130,6\\
        $C_{p, \mathrm{m}}$ / $\si{\joule\per\mole\per\kelvin}$ & 35,31 & 33,58 & 29,14 & 28,82\\\bottomrule
    \end{tabular}
\end{table}

Beim Betrachten der fertigen Aufgabe stellen wir fest, dass die oben angegebene Punktzahl angepasst werden muss, da die bei den Teilaufgaben in Summe vergebene Punktzahl abweicht, worauf eine Fehlermeldung aufmerksam macht.  
